...
public class Main extends Application {
	...
	private void starttime(){
		ConfigGrafico();
		System.out.println("Tamanho do Painel de simula√ß√£o");
	...
	EventHandler<ActionEvent> eventotempo = new EventHandler<ActionEvent>() {
		public void handle(ActionEvent t) {
			...
			world.tick();
			tempo_sim.setText("Tempo de SimulaÁ„o "+String.format("%.2f",world.relogio)+"s");
		}
    };
...
//		  }
		  ...
		  System.out.print("PosiÔøΩÔøΩo X: ");
		  System.out.println(t.getSceneX());
		  System.out.print("PosiÔøΩÔøΩo Y crua: ");
		  System.out.println(t.getSceneY());
		  System.out.print("PosiÔøΩÔøΩo Y corrigida: ");
	...
	//Eventos das formas que s√£o adicionadas
